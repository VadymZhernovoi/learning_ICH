...
# 4. Вывести один столбец из таблицы employees 
#    содержащий имя и фамилию, написанные через пробел. Вывести 3 строки начиная со второй.
SELECT 
    first_name,
    last_name,
...
SELECT DISTINCT
    company, 
    REPLACE(company, 'Company ', '') AS company_short1     # не по заданию, для себя 
FROM
    customers
